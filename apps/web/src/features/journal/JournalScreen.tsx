  ...
  return (
    <div className="px-5 pb-4 pt-2">
      <div className="mb-5 flex items-end justify-between">
        <div>
          <div className="font-serif text-[30px] font-medium text-ink">Moments</div>
          <Label>{memories.length} kept so far</Label>
        </div>
        <button
          onClick={onAdd}
          className="rounded-pill bg-brand p-[11px] shadow-card"
          aria-label="Add a moment"
        >
          <Plus size={18} className="text-[#FFF7F2]" />
        </button>
      </div>
